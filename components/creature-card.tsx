...
const elementBackgroundImages: Record<Element, string> = {
  ...
  Water: "bg-[url('/images/backgrounds/water-bg.jpeg')] bg-cover bg-center bg-no-repeat",
  Earth: "bg-[url('/images/backgrounds/earth-bg.jpeg')] bg-cover bg-center bg-no-repeat",
