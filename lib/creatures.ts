...
const rawRosterData: RawCreatureLineData[] = [
  // 🔥 FIRE ELEMENT
  {
    ...
    element: "Fire",
    creatures: [
      { name: "Sigael", stage: 0, hp: 90, resistance: "Air", weakness: "Water" },
      { name: "Drakalayo", stage: 1, hp: 120, resistance: "Earth", weakness: "Water" },
      { name: "Infernuko", stage: 2, hp: 150, resistance: "Earth", weakness: "Water" },
    ],
  },
  {
    line: "Silabrix",
    element: "Fire",
    creatures: [
      { name: "Asonis", stage: 0, hp: 100, resistance: "None", weakness: "Water" },
      { name: "Silabrix", stage: 1, hp: 130, resistance: "Air", weakness: "Earth" },
      { name: "Alkaulon", stage: 2, hp: 140, resistance: "Air", weakness: "Water" },
    ],
  },
  {
    line: "Magdanok",
    element: "Fire",
    creatures: [
      { name: "Liyabon", stage: 0, hp: 80, resistance: "Water", weakness: "Earth" },
      { name: "Magdanok", stage: 1, hp: 110, resistance: "None", weakness: "Water" },
      { name: "Apoymortis", stage: 2, hp: 160, resistance: "Earth", weakness: "Water" },
    ],
  },
  // 💧 WATER ELEMENT
  {
    ...
    element: "Water",
    creatures: [
      { name: "Lakanis", stage: 0, hp: 90, resistance: "Fire", weakness: "Earth" },
      { name: "Sireniya", stage: 1, hp: 120, resistance: "Fire", weakness: "Air" },
      { name: "Mardagat", stage: 2, hp: 140, resistance: "Fire", weakness: "Earth" },
    ],
  },
  {
    line: "Tundragan",
    element: "Water",
    creatures: [
      { name: "Yelogon", stage: 0, hp: 80, resistance: "Air", weakness: "Earth" },
      { name: "Tundragan", stage: 1, hp: 130, resistance: "Fire", weakness: "Earth" },
      { name: "Niebarko", stage: 2, hp: 160, resistance: "Earth", weakness: "Air" },
    ],
  },
  {
    line: "Agwatara",
    element: "Water",
    creatures: [
      { name: "Ulanik", stage: 0, hp: 100, resistance: "Fire", weakness: "Air" },
      { name: "Agwatara", stage: 1, hp: 110, resistance: "Earth", weakness: "Air" },
      { name: "Tayodora", stage: 2, hp: 150, resistance: "Fire", weakness: "Earth" },
    ],
  },
  // 🌱 EARTH ELEMENT
  {
    ...
    element: "Earth",
    creatures: [
      { name: "Putrani", stage: 0, hp: 110, resistance: "Water", weakness: "Air" },
      { name: "Grobayan", stage: 1, hp: 140, resistance: "Fire", weakness: "Air" },
      { name: "Dunobrak", stage: 2, hp: 160, resistance: "Air", weakness: "Water" },
    ],
  },
  {
    line: "Silvaran",
    element: "Earth",
    creatures: [
      { name: "Anitubi", stage: 0, hp: 90, resistance: "Water", weakness: "Fire" },
      { name: "Silvaran", stage: 1, hp: 130, resistance: "Air", weakness: "Fire" },
      { name: "Barkhilan", stage: 2, hp: 150, resistance: "Water", weakness: "Fire" },
    ],
  },
  {
    line: "Pamantok",
    element: "Earth",
    creatures: [
      { name: "Talahus", stage: 0, hp: 100, resistance: "None", weakness: "Air" },
      { name: "Pamantok", stage: 1, hp: 120, resistance: "Water", weakness: "Fire" },
      { name: "Guwardanox", stage: 2, hp: 170, resistance: "Air", weakness: "Fire" },
    ],
  },
  // 🌬️ AIR ELEMENT
  {
    ...
    element: "Air",
    creatures: [
      { name: "Layawing", stage: 0, hp: 80, resistance: "Earth", weakness: "Fire" },
      { name: "Himpayan", stage: 1, hp: 110, resistance: "None", weakness: "Water" },
      { name: "Zephyltik", stage: 2, hp: 140, resistance: "Earth", weakness: "Fire" },
    ],
  },
  {
    line: "Kaelykat",
    element: "Air",
    creatures: [
      { name: "Haliyas", stage: 0, hp: 90, resistance: "None", weakness: "Earth" },
      { name: "Kaelykat", stage: 1, hp: 120, resistance: "Water", weakness: "Fire" },
      { name: "Bagynox", stage: 2, hp: 150, resistance: "Earth", weakness: "Fire" },
    ],
  },
  {
    line: "Hangguran",
    element: "Air",
    creatures: [
      { name: "Alingaw", stage: 0, hp: 100, resistance: "Earth", weakness: "Water" },
      { name: "Hangguran", stage: 1, hp: 130, resistance: "Earth", weakness: "Fire" },
      { name: "Uludronis", stage: 2, hp: 160, resistance: "None", weakness: "Fire" },
    ],
  },
]
...
export const getNextEvolution = (creature: Creature): Creature | undefined => {
  ...
  if (currentIndex === -1 || currentIndex === creature.evolutionLine.length - 1) {
