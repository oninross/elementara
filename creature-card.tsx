      ...
      {isShowingDetails && (
        <div
          ...
          <div
            ...
            <button
              onClick={handleCloseDetails}
              className="absolute -top-4 -right-4 z-10 w-10 h-10 bg-red-500 text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg border-2 border-white/50"
              title="Close details">
